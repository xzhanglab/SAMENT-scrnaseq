...
def load_data():
    ...
    file_path = os.path.join(dir_path, 'NK_LysM-vs-ctrl_GSVA.csv')
...
def update_plot(keywords=[], exclude_keywords=[], logic='AND', width='100%', height=800, interactive=True):
    ...
    # Set layout
    fig.update_layout(paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(255,255,255,1)', title='NK T cell: LysM vs ctrl',
